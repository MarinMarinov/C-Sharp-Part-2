...
class Program
{
    static void Main()
    {
        ...
        {
            RepresentNumbersAsArraysOfDigits(firstNumber, secondNumber);
        }
        else
        {
    ...
    private static void RepresentNumbersAsArraysOfDigits(BigInteger numberOne, BigInteger numberTwo)
    {
