...
class Program
{
    static void Main()
    {
        ...
        AddPolynom(firstPolynom, secondPolynom);
        Console.WriteLine();

        Subtract(firstPolynom, secondPolynom);
        Console.WriteLine();
    ...
    static void AddPolynom(decimal[] first, decimal[] second)
    {
    ...
    static void Subtract(decimal[] first, decimal[] second)
    {
        PrintPolynomial(first);
        Console.WriteLine("-");
        PrintPolynomial(second);
